...
const DashboardPage = async () => {
  ...
  return (
    <section id="dashboard">
      <section id="game-session" className="flex flex-row w-auto">
        <GameSession data={sessionData}/>
      </section>
      <section id="colums" className="mt-4 flex flex-grow flex-col lg:flex-row md:mt-6 md:gap-6">
        <div className="w-full w-rounded-sm pt-7.5 mb-5 shadow-default sm:px-7.5 lg:w-1/2">
          <StudentChoices data={studentChoices}/>
            <section id="cards" className="hidden lg:flex py-5 w-full">
                <Cards data={studentChoices}/>
            </section>
        </div>

        <div className="w-full rounded-sm pt-7.5 mb-5 shadow-default sm:px-7.5 lg:w-1/2">
          <PerformanceInsight data={studentInsight}/>
        </div>

        <section id="cards-mobile" className="lg:hidden py-5 w-full">
          <Cards data={studentChoices}/>
        </section>
      </section>
